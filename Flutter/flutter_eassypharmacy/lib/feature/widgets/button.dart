...
class GeneralButton extends StatelessWidget {
  ...
  factory GeneralButton.text(String text,
    ...
    Color accentColor = !reverse
        ? textColor ?? systemWhiteColor
        : backgroundColor ?? systemWhiteColor;
    double fontSize = buttonSize == ButtonSize.large ? 16.0 : buttonSize == ButtonSize.medium ? 14.0 : 12.0;
    FontWeight fontWeight = buttonSize == ButtonSize.large
        ? bold ? FontWeight.w700 : FontWeight.w500
        : FontWeight.normal;
    Color? disableTextColor =
    Color.lerp(!reverse ? Colors.white : Colors.black54, systemWhiteColor, 0.6);
  ...
  Widget _buildButton(BuildContext context) {
    double borderWidth = isBorderWidth! ? onlyBorder ? 1.0 : 0.0 : 0.0;
    Color? disableBackgroundColor =
    Color.lerp(reverse ? Colors.white : Colors.black54, systemWhiteColor, 0.6);
    Color? disableTextColor =
    Color.lerp(!reverse ? Colors.white : Colors.black54, systemWhiteColor, 0.6);
    ...
    OutlinedBorder border = RoundedRectangleBorder(
        side: BorderSide(
            color: enable ? isBorderWidth! ? primaryColor : transparentColor : disableBackgroundColor!,
            width: borderWidth),
