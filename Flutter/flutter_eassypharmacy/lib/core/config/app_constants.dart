...
const String sloganStore = "Make You Healthy";
...
const String emailNeed = "Email Required!";
...
const String registerMessage = "Create an account, it's free";
...
const String aZ = "A-Z";
const String zA = "Z-A";
const String zeroHundred = "0-100";
const String hundredZero = "100-0";
